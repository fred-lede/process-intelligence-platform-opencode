...
- **(c) Task 8/9 以相同 filter pattern 延伸**：引擎 `filter_column`/`filter_value` mixin 依序套用到 MC（monte_carlo/run，commit 878f821）與 Exploration（data/distribution + data/series，4ab2313），各走 TDD（紅→綠），全引擎逐次 291→294→300 passed。
