  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <Card title={t('monteCarlo.title')}>
        ...
        />
        {(result as MonteCarloResult & { grain?: { analyzed_row_count?: number } })?.grain && <Typography.Text type="secondary">{t('monteCarlo.filteredSampleCount', { count: (result as MonteCarloResult & { grain: { analyzed_row_count?: number } }).grain.analyzed_row_count })}</Typography.Text>}
        ...
        <>
          ...
          <Alert
            ...
            description={t('monteCarlo.resultSummary', {
              ...
              capability: result.capability?.ppk != null ? `Pp=${result.capability.pp?.toFixed(2)}, Ppk=${result.capability.ppk.toFixed(2)}。` : '',
            })}
            style={{ margin: '12px 0' }}
          />
